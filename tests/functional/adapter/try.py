...
"""
incremental_try_sql ="""{{config(materialized = 'incremental',incremental_strategy = 'delete+insert',unique_key = 'id')}}
...
class BaseIncrementaltry:
    ...
    @pytest.fixture(scope="class")
    def models(self):
        return {"incremental.sql": incremental_try_sql, "schema.yml": schema_base_yml}
...
class Testincrementaltry(BaseIncrementaltry):
    pass